...
from f1_etl import DataConfig, SessionConfig, create_safety_car_dataset
...
def main():
    ...
    data_config = DataConfig(
        sessions=[SessionConfig(2023, "Saudia Arabian Grand Prix", "R")],
    ...
    class_weight = {
        ...
        y_enc.class_to_idx['safety_car']: 50.0,
